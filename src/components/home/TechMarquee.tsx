...
export function TechMarquee() {
  ...
  return (
    <section id="tech-stack" className="py-16 overflow-hidden bg-gray-50 dark:bg-gray-900/50">
          ...
          >
            {duplicatedSkills.map((skill, index) => (
              <div
                ...
                className="flex items-center gap-3 px-6 py-3 bg-white dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700 shadow-sm whitespace-nowrap hover:border-violet-500 dark:hover:border-violet-400 transition-colors cursor-default"
              >
                <div
